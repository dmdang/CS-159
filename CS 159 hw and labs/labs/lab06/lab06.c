...
*
*  Program Description:This program converts the specified place digit from three 4-digit numbers
*  into three separate binary numbers and then concatenates them. From the concatenated binary number, a
*  final decimal number is calculated.
*
***************************************************************************/
#include <stdio.h>
#include <math.h>
...
void displayOutput(int binaryOne, int binaryTwo, int binaryThree, int binaryValue);
...
int main (void)
{
  ...
  int binaryOneD1; // first digit of the first binary number
  int binaryOneD2; // second digit of the first binary number
  int binaryOneD3; // third digit of the first binary number
  int binaryOneD4; // fourth digit of the first binary number
  int binaryTwoD1; // first digit of the second binary number
  int binaryTwoD2; // second digit of the second binary number
  int binaryTwoD3; // third digit of the second binary number
  int binaryTwoD4; // fourth digit of the second binary number
  int binaryThreeD1; // first digit of the third binary number
  int binaryThreeD2; // second digit of the third binary number
  int binaryThreeD3; // third digit of the third binary number
  int binaryThreeD4; // fourth digit of the third binary number
 ...
 // int binaryTotal; // sum of of the three decimal values of the three binary numbers
  ...
  displayOutput(binaryOne, binaryTwo, binaryThree, binaryValue);
...
*
*     Function Description: This function displays the concatenated binary numbere along with its decimal value
*
***************************************************************************/
void displayOutput(int binaryOne, int binaryTwo, int binaryThree, int binaryValue)
{
